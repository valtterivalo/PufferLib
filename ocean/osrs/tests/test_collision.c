...
TEST(test_line_of_sight_negative_delta_uses_defined_fixed_point_math) {
    ASSERT(has_line_of_sight(NULL, 0, 10, 0, 5, 10, 1, -1));
    ASSERT(has_line_of_sight(NULL, 0, 0, 10, 10, 5, 1, -1));
}
...
int main(void) {
    ...
    printf("\nline of sight:\n");
    RUN(test_line_of_sight_negative_delta_uses_defined_fixed_point_math);
