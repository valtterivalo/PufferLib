...
#define PVP_ACTION_SCHEMA_CATEGORY_INVENTORY_V13 13
#define PVP_ACTION_SCHEMA PVP_ACTION_SCHEMA_CATEGORY_INVENTORY_V13
...
#define PVP_INVENTORY_CATEGORY_HEADS (NUM_GEAR_SLOTS + 3)
#define PVP_INVENTORY_CLICKS_PER_TICK PVP_INVENTORY_CATEGORY_HEADS
...
#define NUM_ACTION_HEADS (PVP_INVENTORY_CATEGORY_HEADS + 6)

#define HEAD_EQUIP_BASE 0
#define HEAD_EQUIP_SLOT(slot) (HEAD_EQUIP_BASE + (slot))
#define HEAD_FOOD      (HEAD_EQUIP_BASE + NUM_GEAR_SLOTS)
#define HEAD_KARAMBWAN (HEAD_FOOD + 1)
#define HEAD_DRINK     (HEAD_KARAMBWAN + 1)
#define HEAD_ATTACK    (HEAD_DRINK + 1)
#define HEAD_SPECIAL   (HEAD_ATTACK + 1)
#define HEAD_OVERHEAD  (HEAD_ATTACK + 2)
#define HEAD_VENG      (HEAD_ATTACK + 3)
#define HEAD_OFFENSIVE (HEAD_ATTACK + 4)
#define HEAD_MOVE      (HEAD_ATTACK + 5)
#define HEAD_INVENTORY_0 HEAD_EQUIP_BASE
...
#define PVP_INVENTORY_CATEGORY_ACTION_DIMS \
    INVENTORY_CLICK_DIM, \
    INVENTORY_CLICK_DIM, \
    INVENTORY_CLICK_DIM, \
    INVENTORY_CLICK_DIM, \
...
#define PVP_ACTION_DIMS_LITERAL { \
    PVP_INVENTORY_CATEGORY_ACTION_DIMS, \
    ATTACK_DIM, \
    SPECIAL_DIM, \
    OVERHEAD_DIM, \
    VENG_DIM, \
...
static_assert(NUM_ACTION_HEADS == NUM_GEAR_SLOTS + 3 + 6,
    "PvP action heads must match category inventory layout");
static_assert(HEAD_MOVE == NUM_ACTION_HEADS - 1,
    "PvP move head must be last");
