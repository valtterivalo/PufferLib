...
ANIM_ANCIENT_GODSWORD_SPEC = 9171
ANIM_BALLISTA_SHOOT = 7218
ANIM_DARK_BOW_SHOOT = 426
ANIM_JAVELIN_THROW = 806
ANIM_MORRIGANS_JAVELIN_SPEC = 11467
ANIM_WARHAMMER_CRUSH = 401
ANIM_WARHAMMER_SPEC = 1378
ANIM_WILD_CAVE_CHAINMACE_READY = 244
ANIM_WILD_CAVE_CHAINMACE_WALK = 247
ANIM_WILD_CAVE_CHAINMACE_RUN = 248
ANIM_RAPIER_STAB = 8145
ANIM_MACE_CRUSH = 400
ANIM_INQUISITOR_SPEC = 1060
ANIM_ELDER_MAUL_CRUSH = 7516
ANIM_VOIDWAKER_SPEC = 11275
ANIM_VOIDWAKER_SPEC_ALT = 11240
ANIM_VLS_SLASH = 390
ANIM_VLS_SPEC = 7515
...
NEEDED_ANIMATIONS = {
    ...
    ANIM_CROSSBOW_SHOOT, ANIM_ZCB_ATTACK, ANIM_SCIMITAR_SLASH,
    ...
    ANIM_GODSWORD_SPEC_AGS, ANIM_ANCIENT_GODSWORD_SPEC,
    ANIM_BALLISTA_SHOOT, ANIM_DARK_BOW_SHOOT,
    ANIM_JAVELIN_THROW, ANIM_MORRIGANS_JAVELIN_SPEC,
    ANIM_WARHAMMER_CRUSH, ANIM_WARHAMMER_SPEC,
    ANIM_WILD_CAVE_CHAINMACE_READY, ANIM_WILD_CAVE_CHAINMACE_WALK,
    ANIM_WILD_CAVE_CHAINMACE_RUN,
    ANIM_RAPIER_STAB, ANIM_MACE_CRUSH, ANIM_INQUISITOR_SPEC,
    ANIM_ELDER_MAUL_CRUSH, ANIM_VOIDWAKER_SPEC, ANIM_VOIDWAKER_SPEC_ALT,
