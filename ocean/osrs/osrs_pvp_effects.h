...
static int effect_spawn_spotanim_subtile(
    ...
    return effect_spawn_spotanim_subtile_height(effects, gfx_id,
        subtile_x, subtile_y, 0.0f, current_client_tick, spotanims, anim_cache,
        model_cache, secondary_model_cache, projectile_model_cache);
}
