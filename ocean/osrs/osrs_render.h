        ...
        if (p->hit_landed_this_tick) {
            ...
            if (att_is_powered_staff &&
                ...
                if (p->hit_was_successful) {
                    render_spawn_entity_spotanim_height(
                        rc, p, i, att_magic_profile->impact_spotanim_id,
                        osrs_combat_projectile_profile_impact_height_subtile(
                            att_magic_profile),
                        ct);
                } else {
                    render_spawn_entity_spotanim_height(rc, p, i, GFX_SPLASH, 0, ct);
                }
            } else {
