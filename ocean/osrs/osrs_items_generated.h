...
typedef enum {
    ...
    ITEM_SCYTHE_OF_VITUR = 101,
    ITEM_BLADE_OF_SAELDOR = 102,
    ITEM_OSMUMTENS_FANG = 103,
    ITEM_SOULREAPER_AXE = 104,
    ITEM_TORVA_FULL_HELM = 105,
    ITEM_TORVA_PLATEBODY = 106,
    ITEM_TORVA_PLATELEGS = 107,
    ITEM_BANDOS_CHESTPLATE = 108,
    ITEM_BANDOS_BOOTS = 109,
    ITEM_PRIMORDIAL_BOOTS = 110,
    ITEM_FEROCIOUS_GLOVES = 111,
    ITEM_AMULET_OF_TORTURE = 112,
    ITEM_BERSERKER_RING_I = 113,
    ITEM_ULTOR_RING = 114,
    ITEM_AVERNIC_DEFENDER = 115,
    ITEM_VENATOR_RING = 116,
    ITEM_VIRTUS_MASK = 117,
    ITEM_VIRTUS_ROBE_TOP = 118,
    ITEM_VIRTUS_ROBE_BOTTOM = 119,
    ITEM_MAGUS_RING = 120,
    ITEM_TUMEKENS_SHADOW = 121,
    ITEM_BGS = 122,
    ITEM_SGS = 123,
    ITEM_ZGS = 124,
    ITEM_CRYSTAL_HALBERD = 125,
    ITEM_DRAGON_BATTLEAXE = 126,
    ITEM_RUBY_DRAGON_BOLTS_E = 127,
    ITEM_DIAMOND_DRAGON_BOLTS_E = 128,
    ITEM_RUNE_ARROW = 129,
    ITEM_DRAGON_JAVELIN = 130,
    ITEM_SPECTRAL_SPIRIT_SHIELD = 131,
    ITEM_ELYSIAN_SPIRIT_SHIELD = 132,
    ITEM_DRAGONFIRE_SHIELD = 133,
    ITEM_DRAGON_HUNTER_WAND = 134,
    ITEM_ECHO_BOOTS = 135,
    ITEM_SERPENTINE_HELM = 136,
    ITEM_AMULET_OF_BLOOD_FURY = 137,
    ITEM_FIGHTER_TORSO = 138,
    ITEM_AMULET_OF_RANCOUR = 139,
    ITEM_OATHPLATE_CHEST = 140,
...
static const Item ITEM_DATABASE[NUM_ITEMS] = {
    ...
    [ITEM_VENATOR_BOW] = {
        .item_id = 27610, .name = "Venator bow", .slot = SLOT_WEAPON,
        .two_handed = 1,
        .attack_speed = 5, .attack_range = 6,
        .attack_stab = 0, .attack_slash = 0, .attack_crush = 0,
        .attack_magic = 0, .attack_ranged = 90,
        .defence_stab = 0, .defence_slash = 0, .defence_crush = 0,
        .defence_magic = 0, .defence_ranged = 0,
    ...
    [ITEM_ABYSSAL_TENTACLE] = {
        ...
        .attack_speed = 4, .attack_range = 1,
        .attack_stab = 0, .attack_slash = 90, .attack_crush = 0,
        .attack_magic = 0, .attack_ranged = 0,
        .defence_stab = 0, .defence_slash = 0, .defence_crush = 0,
        .defence_magic = 0, .defence_ranged = 0,
