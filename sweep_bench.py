    ...
    "osrs_zulrah": {
        **_SWEEP_BASE,
        ...
        "train": {
            ...
            "horizon": {"distribution": "uniform_pow2", "min": 16, "max": 256, "scale": "auto"},
            "learning_rate": {"distribution": "log_normal", "min": 0.0005, "max": 0.03, "scale": 0.5},
...
DEFAULT_PARAMS_PER_ENV = {
    ...
    # osrs_zulrah anchor: pvp-derived config that got 26% winrate at 3.3M steps with shaping
    "osrs_zulrah": {
        "train": {
            "total_timesteps": 100_000_000,
            "horizon": 16,
