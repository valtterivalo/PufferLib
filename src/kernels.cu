...
static const char* optimizer_param_role_name(int role) {
    switch (role) {
        case OPT_PARAM_UNTAGGED: return "untagged";
        case OPT_PARAM_ENCODER: return "encoder";
        case OPT_PARAM_DECODER: return "decoder";
        case OPT_PARAM_LOGSTD: return "logstd";
        case OPT_PARAM_MINGRU: return "mingru";
        case OPT_PARAM_CONV: return "conv";
        case OPT_PARAM_EMBEDDING: return "embedding";
