...
def main() -> None:
    ...
    summary = {
        ...
        "perf_rollout_fwd": last_metric(metrics, "perf/rollout_fwd"),
        "perf_train": last_metric(metrics, "perf/train"),
        "perf_train_sync": last_metric(metrics, "perf/train_sync"),
        "perf_train_forward": last_metric(metrics, "perf/train_forward"),
        "perf_train_fwd": last_metric(metrics, "perf/train_fwd"),
