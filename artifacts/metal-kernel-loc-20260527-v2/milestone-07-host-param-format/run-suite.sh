...
"$SCRIPT_DIR/run-breakout.sh"
"$SCRIPT_DIR/run-g2048.sh"
"$SCRIPT_DIR/../bin/run-gpu-inference-smoke.sh" milestone-07-host-param-format
cd "$REPO_ROOT"
...
"$SCRIPT_DIR/../bin/run-interactive-smoke.sh" milestone-07-host-param-format host-param-format
