...
"$SCRIPT_DIR/run-breakout.sh"
"$SCRIPT_DIR/run-g2048.sh"
"$SCRIPT_DIR/../bin/run-gpu-inference-smoke.sh" milestone-06-dead-prototypes
cd "$REPO_ROOT"
...
"$SCRIPT_DIR/../bin/run-interactive-smoke.sh" milestone-06-dead-prototypes dead-prototypes
