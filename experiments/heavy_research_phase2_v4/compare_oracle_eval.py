...
KEYS = [
    ...
    ("env/frac_zuk_healers_tagged_ge_1_normal", "tag1"),
    ("env/frac_zuk_healers_tagged_ge_4_normal", "tag4"),
    ("env/frac_zuk_healers_killed_ge_1_normal", "kill1"),
    ("env/frac_zuk_healers_killed_ge_4_normal", "kill4"),
    ("env/frac_all_zuk_healers_dead_normal", "heal_done"),
    ...
    ("env/frac_died_after_240_never_tagged_healer_normal", "die_notag"),
    ("env/frac_died_after_240_some_healers_tagged_normal", "die_tag"),
    ("env/frac_died_after_240_some_healers_killed_normal", "die_kill"),
    ("env/frac_died_after_240_all_healers_dead_normal", "die_done"),
    ...
    ("env/hp_restored_after_240_normal", "hp_heal240"),
    ("env/spark_damage_after_240_normal", "spark240"),
